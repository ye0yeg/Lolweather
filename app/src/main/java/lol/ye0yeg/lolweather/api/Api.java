...
import lol.ye0yeg.lolweather.utils.NetWorkUtils;
...
public class Api {
    ...
    private Api(int hostType, int xmlType) {
        ...
        File cacheFile = new File(BaseApplication.mContext.getCacheDir(), "cache");
...
//                .cache(cache)
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(BaseApplication.mContext) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
